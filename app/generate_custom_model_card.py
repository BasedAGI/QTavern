...
def generate_custom_model_card(model_id, base_model_name, quant_method, username, save_folder, license="mit", datasets=None):
    ...
    # Define the list of audio files with associated captions.
    audios = [
        ...
        {"file": "012.mp3", "caption": "El Cascabel – Antonio Maciel and Los Aguilillas with Mariachi México de Pepe Villa / Rafael Carrión (Mexico, Unknown)"},
    ]
    ...
    # Define conditional sections separately to avoid nesting triple-quoted f-strings.
    gguf_section = ""
    if "GGUF" in formatted_qtype:
        gguf_section = f"""
### What is a GGUF?
...
"""
    ...
    # Build the custom content with the selected image, audio, and conditional sections.
    custom_content = f"""
